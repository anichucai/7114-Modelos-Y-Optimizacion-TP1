...
def get_largest_clique(M, datos_prendas):
...
def resolver(incompatibilidades, datos_prendas):
    ...
    while(len(prendas_a_lavar) != 0):
        clique = get_largest_clique(M, datos_prendas)
        res.append(clique)
...
def main():
    ...
    generate_result(res, 'outputs/heuristica_clique_largest_max_entrega_2.txt')
